...
![xefag](https://github.com/user-attachments/assets/101f35b1-af5e-4811-9020-6fa7cbd2469e)
...
1. Clone the repository:
   ...
   ```bash
   [git clone https://github.com/YOUR-USERNAME/YOUR-REPO.git](https://github.com/ThembelihleQueeneth/-React-Native-UI-Challenge.git)
   ```
